...
import {ImmutableStateUpgradeable} from "./ImmutableStateUpgradeable.sol";
...
abstract contract BaseHookUpgradeable is IHooks, ImmutableStateUpgradeable, UUPSUpgradeable, OwnableUpgradeable {
    ...
    /// @notice Allows the current implementation to be changed by the owner
    /// @dev Uses onlyOwner modifier from OwnableUpgradeable. Can be overriden in derived contracts.
